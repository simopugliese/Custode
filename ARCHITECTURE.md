...
6. **Calendario + motore di contesto** (sync in sola lettura, tagging eventi, tipi di evento tuoi, regole dettate da te, poi le auto-proposte basate su pattern). *In corso: fatti il calendario e il tagging, e i tipi che decidi tu (§8.10 «Stato attuale»); mancano le regole di contesto.*
