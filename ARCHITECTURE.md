...
| Tipo di un evento di calendario (lezione/palestra/viaggio/altro) | DeepSeek | classificazione semplice da un titolo, una chiamata per tutta la coda |
